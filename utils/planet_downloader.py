    ...
    def download_image(self, lat, lon, min_year, min_month, max_year, max_month, zoom=14, cloud_max=0.05):
        ...
        result = \
          requests.post(
            ...
            auth=HTTPBasicAuth('d2f9677f4bea4e69bd588675d4075b0a', ''),
            json=search_endpoint_request)
        
        res = json.loads(result.text)
        #print("Size of res: " , len(res))
        ...
        url = "https://tiles0.planet.com/data/v1/{}/{}/{}/{}/{}.png?api_key={}".format(self.item_type, item_id, zoom, x, y, "d2f9677f4bea4e69bd588675d4075b0a")
        #print(url)
